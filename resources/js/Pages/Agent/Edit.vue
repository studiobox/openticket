...
const createAgent = () => {
    ...
    form.put(route('agent.update', { agent: props.agent.id }))
}
...
<template>
    <MainLayout>
        <div class="page-heading">
            <h2 class="page-title">Edit Agent</h2>
        </div>
        ...
        <div class="mt-6">
            <form @submit.prevent="createAgent">
                <Card>
                    ...
                    <template #footer>
                        <button type="submit" class="btn-md btn-primary">Update Agent</button>
